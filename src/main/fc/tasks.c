...
task_attribute_t task_attributes[TASK_COUNT] = {
    ...
    [TASK_SERIAL] = DEFINE_TASK("SERIAL", NULL, NULL, taskHandleSerial, TASK_PERIOD_HZ(500), TASK_PRIORITY_LOW), // 500 Hz - raised for companion-computer MSP_RAW_IMU polling on this rig (UART6 @ 500000 baud)
